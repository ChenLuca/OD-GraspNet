...
class Generative_ODC_Shuffle_UNetCbam_4_Max(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_ODC_Shuffle_UNetCbam_4_Max, self).__init__()

        print("Generative_ODC_Shuffle_UNetCbam_4_Max")
        ...
        self.chl_cbam1 = CBAM(self.conv6_in)
        ...
        self.chl_cbam2 = CBAM(self.conv7_in)
        ...
        self.chl_cbam3 = CBAM(self.conv8_in)
        ...
        self.chl_cbam4 = CBAM(self.image_in)
