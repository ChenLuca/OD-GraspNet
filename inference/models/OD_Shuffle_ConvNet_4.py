...
class Generative_OD_Shuffle_4(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_OD_Shuffle_4, self).__init__()

        print("Generative_OD_Shuffle_4")
    ...
    def forward(self, x_in):
        ...
        x = F.relu(self.bn4(self.sf1(x)))
        x = F.relu(self.bn5(self.sf2(x)))
