...
class Generative_ODC_Shuffle_UNet_4_CbamFirst(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_ODC_Shuffle_UNet_4_CbamFirst, self).__init__()

        print("Generative_ODC_Shuffle_UNet_4_CbamFirst")
        ...
        self.cbam1 = CBAM(self.osa_conv_kernal[0]*self.osa_depth)
    ...
    def forward(self, x_in):
        ...
        x = self.trans1(self.cbam1(self.block1(x_4_down)))
