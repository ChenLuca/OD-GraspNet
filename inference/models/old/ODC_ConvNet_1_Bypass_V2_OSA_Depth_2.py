...
class Generative_ODC_1_Bypass_V2_OSA_Depth_2(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_ODC_1_Bypass_V2_OSA_Depth_2, self).__init__()

        print("Generative_ODC_1_Bypass_V2_OSA_Depth_2")
        ...
        self.cbam6 = CBAM(self.concat_2_size, 8)
