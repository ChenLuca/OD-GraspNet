...
class Generative_ODC_Shuffle_UNet_1(GraspModel):

    def __init__(self, input_channels=4, output_channels=1, channel_size=256, dropout=False, prob=0.0):
        super(Generative_ODC_Shuffle_UNet_1, self).__init__()

        print("Generative_ODC_Shuffle_UNet_1")
    ...
    def forward(self, x_in):
        ...
        x = self.cbam2(self.trans2(self.block2(x)))
        x = self.cbam3(self.trans3(self.block3(x)))
        x = self.cbam4(self.trans4(self.block4(x)))
